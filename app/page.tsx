  ...
  return (
    <main className="p-6">
      ...
      <form action={handleCreate} className="mb-6 space-y-3">
        <input name="title" placeholder="Note title" className="border p-2 w-full rounded" required />
        <textarea name="content" placeholder="Note content" className="border p-2 w-full rounded" required />
